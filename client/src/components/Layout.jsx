...
import {
  ShoppingCart, User, LogOut, Menu, X, Leaf, Heart, Crown,
  BarChart3, Package, ShieldAlert, Warehouse, Truck,
} from 'lucide-react';
      ...
      <header className={`sticky top-0 z-40 transition-all duration-500 ${
        ...
        <div className="container flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-1.5">
            ...
            {/* Cart — only functional when logged in */}
            <Button
              variant="ghost"
              size="icon"
              className="relative"
